...
<body>
<form action="RegAccountC" onsubmit="return check()" name="myForm">
	...
	<tr>
		<td>&nbsp;&nbsp;PW 확인</td>
		<td><input name="pww" id="pww" type="password"></td>
	</tr>
	<tr>
	<td>&nbsp;&nbsp;성별</td>
	 <td>
	...
	<tr>
	 <td>&nbsp;&nbsp;전화번호</td>
	 <td> <input name="num1" size="3" value="010">-<input name="num2" size="5" id="num2">-<input name="num3" size="5" id="num3"> </td>
	</tr>
	<tr>
		<td colspan="2" style="color: white;">-----------</td>
	</tr>
