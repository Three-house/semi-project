		...
		<tr>
			<td>
				<table id="tbl_community_head">
					<tr>
						<td><h2 style="font-family: 'Jua', sans-serif" align="center">커뮤니티</h2>
					...
					<c:forEach var="c" items="${communities }">
						<tr class="com_tr1">
							...
							<td class="com_td1"
								...
								${c.title }</td>
							<td class="com_td1"
								onclick="location.href = 'ComDetailC?num=${c.no}'"><fmt:formatDate
									value="${c.date }" type="date" dateStyle="long" /></td>
						</tr>
					</c:forEach>
				</table>
			</td>
		...
		<tr>
			<td>
				<table id="tbl_community_such">
					<tr>
						<td><input id="search" name="search" placeholder="제목을 입력해주세요">
						</td>
						<td>
