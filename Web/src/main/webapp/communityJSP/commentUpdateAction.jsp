...
<%@ page import="com.tr.comment.CommentDAO"%>
<%@ page import="com.tr.comment.Comment"%>
...
<body>
		...
		if (bbsID == 0) {
			...
			script.println("location.href = 'com_jsp/community.jsp'");
			script.println("</script>");
		}
			...
			script.println("</script>");				
	 		...
	 		if (comment.getCommentText().equals("")){
				...
				if (result == -1) {
					...
					PrintWriter script = response.getWriter();
					script.println("<script>");
					script.println("location.href= \'com_jsp/com_detail.jsp?boardID="+boardID+"&bbsID="+bbsID+"\'");
					script.println("</script>");
				}
			}
		}
